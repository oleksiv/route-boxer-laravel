...
window.GoogleMapsLoader = __webpack_require__(57);
...
if (document.querySelector('#map')) {
    GoogleMapsLoader.load(function (google) {
        ...
        var RouteBoxer = __webpack_require__(290);
        ...
        var latitude = elem.getAttribute('latitude') ? elem.getAttribute('latitude') : 55.7;
        var longitude = elem.getAttribute('longitude') ? elem.getAttribute('longitude') : 37.5;
        ...
        function calcRoute() {
            ...
            directionsService.route(request, function (response, status) {
                ...
                if (status == google.maps.DirectionsStatus.OK) {
                    ...
                    var boxes = routeBoxer.box(path, distance); // Precision in KM
